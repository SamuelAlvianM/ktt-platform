-- SIDAKO — tambah dimensi PERIODE (tahun + semester) pada m_demografi_wilayah.
--
...
-- SQL bawaannya menambah kedua kolom NOT NULL TANPA nilai awal. 111 baris yang
...
-- 111 baris ini: jenis-kelamin, kk, wajib-ktp; 5 kecamatan + 32 desa; kode 6504
-- Tana Tidung. Disunting manual di editor antara 21 Jul - 18 Agu 2026; tidak
-- pernah ada impor Excel, jadi tidak ada jejak periode selain kunci di atas.
...
--
-- Jalankan di server produksi (VPS 76.13.19.247):
--
...
--
-- Verifikasi sesudahnya (111 baris, semuanya 2025/2):
