 ...
 */
const INSTANSI = {
  pemerintah: "PEMERINTAH KABUPATEN TANA TIDUNG",
  dinas: "DINAS KEPENDUDUKAN DAN PENCATATAN SIPIL",
  alamat: "Jl. Perkantoran Pemda, Tideng Pale, Kec. Sesayap  ·  Telp (0553) 2022XXX",
  wilayah: "TANA TIDUNG  ·  KALIMANTAN UTARA",
  portal: "Portal SIDAKO",
  logo: "LOGO-dinas_sidako.png",
  /** Warna aksen ARGB (oranye SIDAKO #B45309). */
  aksen: "FFB45309",
  aksenMuda: "FFFDF3E7",
};
...
async function dataAkun(now: Date): Promise<Tabel> {
  ...
  return {
    ...
    baris: barisBernomor([
      ["Warga", jumlah([3])],
      ["Operator OPD", jumlah([4])],
      ["Staff Dinas (admin & operator capil)", jumlah([1, 2])],
